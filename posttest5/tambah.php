...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conn, "INSERT into karang_taruna values('','$nama','$nik','$nkk','$jenis_kelamin')");
    ...
    <section class="hero" id="hero">
        <div class="box-input">
            <form action="" method="post">
                <p>Tambah Anggota Karang Taruna</p><hr>
                <label for="nama"><p>Nama</p></label>
                <input type="text" name="nama" id="nama">
                <label for="nik"><p>NIK</p></label>
                <input type="number" name="nik" id="nik">
                <label for="nkk"><p>NKK</p></label>
                <input type="number" name="nkk" id="nkk">
                <label for="jenis_kelamin"><p>Jenis Kelamin</p></label>
