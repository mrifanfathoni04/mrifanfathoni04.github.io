...
if(!isset($_SESSION['login'])) {
    echo "
    <script>
        alert('login terlebih dahulu sebelum menambahkan data');
        document.location.href = 'login.php'
    </script>";    
    exit;
}

$result = mysqli_query($conn, "select * from reglog");
$karang_taruna = [];
    ...
    <div class="dashboard">
        <section class="dashboard-utama">
            ...
            <table>
                ...
                <tbody>
                    <?php $i = 1;
                    foreach ($reglog as $rl) : ?>
                        <tr>
                            <td><?php echo $i ?></td>
                            <td><?php echo $rl["username"] ?></td>
                            <td><?php echo $rl["email"] ?></td>
                            <td><?php echo $rl["no_hp"] ?></td>
                        </tr>
                    <?php $i++;
                    endforeach; ?>
                </tbody>
